...
'''
Function to adding an extension to files without an extension
...
def add_extension(directory: str, add_extension_to_file: str, add_filext_path: str) -> None:
        ...
        for filename in os.listdir(directory):
            ...
            if not os.path.splitext(filename)[1]:
                ...
                try:
                    ...
                    base_filename = filename + add_extension_to_file
                    print(f"{file_counter}. "
